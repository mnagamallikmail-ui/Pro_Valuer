  ...
  Widget build(BuildContext context) {
    ...
    return AppLayout(
      ...
      child: LayoutBuilder(builder: (context, constraints) {
        ...
        return Column(
          children: [
            // Toolbar (Refined Title)
            _buildToolbar(r, isMobile),

            // Main Content Area (Focused on Q&A)
            Expanded(
              child: SingleChildScrollView(
                padding: EdgeInsets.symmetric(horizontal: isMobile ? 12 : 32, vertical: 24),
                child: Center(
                  child: ConstrainedBox(
                    constraints: const BoxConstraints(maxWidth: 900), // Narrower for better reading
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        if (isMobile) ...[
                          _buildInstructions(true),
...
class _FieldCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.background, // Solid white
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: AppColors.border),
        boxShadow: [
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(v.questionText, style: AppTypography.heading3.copyWith(fontSize: 18, color: AppColors.textPrimary)),
          const SizedBox(height: 8),
          Text(v.displayLabel, style: AppTypography.label.copyWith(color: AppColors.textSecondary, fontSize: 11)),
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              hintText: v.isDate ? 'Select date...' : 'Enter response...',
              fillColor: AppColors.structural, // Subtle aqua for input fill
              filled: true,
...
class _ImageFieldCard extends StatelessWidget {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.background, // Solid white
          borderRadius: BorderRadius.circular(16),
          border: Border.all(color: hasImage ? AppColors.secondary.withOpacity(0.5) : AppColors.border),
          boxShadow: [
            BoxShadow(color: Colors.black.withOpacity(0.02), blurRadius: 10, offset: const Offset(0, 4)),
          ],
        ),
  ...
  Widget _buildInfo() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(v.questionText, style: AppTypography.heading3.copyWith(fontSize: 18)),
