                  ...
                  child: _banks.isEmpty
                      ...
                      : DropdownButtonFormField<String>(
                          decoration: InputDecoration(
                            ...
                            fillColor: AppColors.structural,
                            filled: true,
                          ...
                          value: _selectedBank,
                          items: [
                            const DropdownMenuItem(value: null, child: Text('All Banks')),
                ...
                _cell(Row(
                  children: [
                    if (AuthService().session?.isAdmin ?? false) ...[
                      ...
                      IconButton(
                        onPressed: () => context.push('/templates/${t.templateId}/revise'),
                        icon: const Icon(Icons.edit_document),
                        tooltip: 'Revise Template',
...
class _TemplateCard extends StatelessWidget {
  ...
  const _TemplateCard({required this.template, required this.onDelete, required this.onConfirm});
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(template.bankName, style: AppTypography.label.copyWith(color: AppColors.textSecondary)),
                    const SizedBox(height: 4),
                    Text(template.templateName, style: AppTypography.subheading),
                  ],
                ),
              ),
              StatusChip(status: template.parsedStatus),
            ],
          ),
          const SizedBox(height: 20),
          Row(
            ...
            children: [
              Text('${template.placeholderCount ?? 0} Placeholders', style: AppTypography.label),
              Text(template.createdAt != null ? DateFormat('dd-MMM-yyyy').format(template.createdAt!) : '—', style: AppTypography.label),
            ],
          ),
          ...
          Row(
            ...
            children: [
              if (isAdmin) ...[
                ...
                IconButton(
                  onPressed: () => context.push('/templates/${template.templateId}/revise'),
                ...
                Text('View Only', style: AppTypography.label.copyWith(color: AppColors.textSecondary)),
            ],
          ),
        ],
      ),
